...
- предложи команду установки через `npx skills add <owner/repo> ...` (или skill.sh); для этого пакета предпочитай единый public setup skill: `npx skills add mrvladd-d/memobank --skill memobank`,
