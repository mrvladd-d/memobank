...
> **Note**: `cold-start` is an internal **flow module** in the source repository.
...
> The public package skill is `memobank`; it sets up the repo and then hands off to generated project commands.
